...
{
    public abstract class HRISDBRepositoryBase<T> where T : class
    {
        #region Properties
        private HRISDBDBContext DataContext;
        private readonly IDbSet<T> DBSet;
        private string ConStr;

        enum ExecType { List, Single, NoExecRecord };

        protected HRISDBIDBFactory DBFactory
        {
            get;
            private set;
        }
        ...
        protected HRISDBDBContext DBContext
        {
            get { return DataContext ?? (DataContext = DBFactory.Init()); }
        }
       

        protected HRISDBRepositoryBase(HRISDBIDBFactory DBFactory)
        {
